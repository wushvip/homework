...
public class BCSEClient1 {
	...
	public BCSEClient1(String appId, String userId, String ip, int port,String secretAccessKey) throws Exception {
	...
	public BCSEClient1(String appId, String ip, int port, String url,String secretAccessKey) throws Exception {
		this(appId, "admin", ip, port, new HashMap<String, Object>(), url,secretAccessKey);
	}

	public BCSEClient1(String appId, String userId, String url,String secretAccessKey) throws Exception {
	}

	public BCSEClient1(String appId, String userId, String ip, int port, Map<String, Object> opts, String url,String secretAccessKey)
			throws Exception {

...
public class AppInfoBean implements Serializable{
	...
	// 昨日请求量峰值
	private int searchMaxNumOneSecond;
	...
	public int getSearchMaxNumOneSecond() {
		return searchMaxNumOneSecond;
	}

	public void setSearchMaxNumOneSecond(int searchMaxNumOneSecond) {
		this.searchMaxNumOneSecond = searchMaxNumOneSecond;
	}

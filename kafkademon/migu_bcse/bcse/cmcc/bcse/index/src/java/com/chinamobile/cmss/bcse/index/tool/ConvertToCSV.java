...
public class ConvertToCSV {
	 ...
	 * @return: void
	 */
	public static void writeToCsv(List<String[]> Result, String FilePath, char fileSplit) throws Exception {
		writer = new CSVWriter(new FileWriterWithEncoding(new File(FilePath), "UTF-8"), fileSplit);

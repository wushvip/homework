...
public class bigFileSplit {
	...
	public static void main(String[] args) {
		ArrayList<String> files = process("C:\\Users\\Administrator\\Desktop\\fromJson.csv");
	...
	// 100M文件
	private final static int splitSize = 10000000;
	...
	public static ArrayList<String> cutFile(String fileName, int fileNum, File f) throws Exception {
		...
		String dicPath = parentPath + File.separator + "split";

...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements jws.HelloWorldImplService {
    ...
    private java.lang.String HelloWorld_address = "http://127.0.0.1:8080/axis/services/HelloWorld";
    ...
    public jws.HelloWorldImpl getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            jws.HelloWorldSoapBindingStub _stub = new jws.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (jws.HelloWorldImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                jws.HelloWorldSoapBindingStub _stub = new jws.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://127.0.0.1:8080/axis/services/HelloWorld", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://127.0.0.1:8080/axis/services/HelloWorld", "HelloWorld"));
        }

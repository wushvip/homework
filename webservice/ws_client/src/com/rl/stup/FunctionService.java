 ...
 * 
 */
@WebServiceClient(name = "FunctionService", targetNamespace = "http://demo/", wsdlLocation = "http://172.20.18.149:8080/demo/function?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://demo/", "FunctionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.20.18.149:8080/demo/function?wsdl");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://demo/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo/", "FunctionPort"), Function.class, features);
    }

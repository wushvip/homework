 ...
 * generated in the com.rl.stup package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWords_QNAME = new QName("http://demo/", "transWords");
    private final static QName _TransWordsResponse_QNAME = new QName("http://demo/", "transWordsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rl.stup
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo/", name = "transWords")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://demo/", name = "transWordsResponse")
